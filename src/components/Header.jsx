        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {authLoading ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 whitespace-nowrap"
            >
              {/* Google icon */}
